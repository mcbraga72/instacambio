...
return [
    ...
    'composer' => [
        'install' => function (Composer $composer, $task) {
            return $composer->install([], ['--no-interaction' => null, '--no-dev' => null, '--prefer-dist' => null, '--optimize-autoloader' => null]);
        },
        'update' => function (Composer $composer, $task) {
            return $composer->update([], ['--optimize-autoloader' => null]);
        },
    ],
