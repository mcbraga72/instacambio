...
return [
    ...
    'logs'             => function (ConnectionsHandler $connections) {
        return sprintf('%s-%s-%s.log', $connections->getConnection(), $connections->getStage(), date('Ymd-His'));
    },
    ...
    'connections'      => [
        ...
        'dev' => [
            ...
            'username'  => 'vagrant',
            'password'  => '',
            'key'       => '/home/gleidson/boxes/vagrant-php5.6-pthreads/.vagrant/machines/pthreads01/virtualbox/private_key',
            'keyphrase' => '',
        ],
    ],
